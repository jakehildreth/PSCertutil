...
# Generated at: 03/12/2026 07:45:58
...
function Get-PSCCAAdministrator
{
[PowerShellCustomFunctionAttribute(RequiresElevation=$False)]
[CmdletBinding()]
...
function Get-PSCCertificateManager
{
[PowerShellCustomFunctionAttribute(RequiresElevation=$False)]
[CmdletBinding()]
...
function Get-PSCEnrollmentAgent
{
[PowerShellCustomFunctionAttribute(RequiresElevation=$False)]
[CmdletBinding()]
...
function Enable-PSCInterfaceFlag
{
[PowerShellCustomFunctionAttribute(RequiresElevation=$False)]
[CmdletBinding()]
...
[Parameter(ParameterSetName='Default')]
[PSDefaultValue(Value="CA\InterfaceFlags")]
[string]$SetReg = "CA\InterfaceFlags",
...
function Disable-PSCInterfaceFlag
{
[PowerShellCustomFunctionAttribute(RequiresElevation=$False)]
[CmdletBinding()]
...
function Get-PSCDisableExtensionList
{
[PowerShellCustomFunctionAttribute(RequiresElevation=$False)]
[CmdletBinding()]
...
[string]$CAFullName,
[Parameter(ParameterSetName='Default')]
[PSDefaultValue(Value="policy\DisableExtensionList")]
[string]$GetReg = "policy\DisableExtensionList"
    )
...
BEGIN {
    ...
    $__outputHandlers = @{
        Default = @{ StreamOutput = $False; Handler = 'parseDisableExtensionList' }
    }
}
...
.PARAMETER GetReg
Specify policy\DisableExtensionList
...
function Get-PSCSanCertificate
{
[PowerShellCustomFunctionAttribute(RequiresElevation=$False)]
[CmdletBinding()]
...
[string]$view,
[Parameter(ParameterSetName='Default')]
[PSDefaultValue(Value="'Binary Certificate,Request.CallerName'")]
[string]$Out = "'Binary Certificate,Request.CallerName'",
[Parameter(ParameterSetName='Default')]
[PSDefaultValue(Value="")]
[string]$csv
    )
...
BEGIN {
    ...
    $__outputHandlers = @{
        Default = @{ StreamOutput = $False; Handler = 'parseSanCertificate' }
    }
}
...
BEGIN {
    ...
    $__outputHandlers = @{
        Default = @{ StreamOutput = $False; Handler = 'parseLog' }
    }
}
